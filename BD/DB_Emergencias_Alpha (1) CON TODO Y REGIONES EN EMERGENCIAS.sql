...
--
-- Host: localhost:3306
-- Generation Time: Dec 15, 2016 at 12:26 AM
...
INSERT INTO `emergencies` (`id`, `commune_id`, `admin_id`, `region_id`, `name`, `date`, `place`, `severity`, `description`, `status`) VALUES
(1, 1, 2, 13, 'Inundacion en ñuble', '2016-12-25', 'nuble chico', 'G', 'SE INUNDO EL PUEBLO', 'En Progreso'),
(5, 3, 2, 13, 'Incendio en casa', '2014-05-05', 'mi casa', 'G', 'mi casa se quema xDDDD.', 'Cancelada'),
(9, 3, 1, 13, 'Vermillion Apocalypse', '2024-11-11', 'Zolezzi\'s Tower', 'G', 'OH GOD WHAT THE HELL IS GOING ON HERE?!?!?', 'En Progreso');
...
--
-- Dumping data for table `emergenciesneed_skills`
--

INSERT INTO `emergenciesneed_skills` (`emergency_id`, `skill_id`) VALUES
(9, 1),
(9, 2),
(9, 3);
...
CREATE TABLE `volunteers` (
  `id` int(11) NOT NULL,
  `rut_volunteer` varchar(25) NOT NULL,
  `task_id` int(11) DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  `name` varchar(25) NOT NULL,
  `last_name_first` varchar(25) NOT NULL,
  `last_name_second` varchar(25) NOT NULL,
  `age` int(11) NOT NULL,
  `residency` varchar(30) NOT NULL,
  `mail` varchar(30) NOT NULL,
  `disponibility` tinyint(1) NOT NULL,
  `performance_area` varchar(25) NOT NULL,
  `experience` int(11) DEFAULT '0',
  `phone` varchar(20) NOT NULL,
  `actual_ubication` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `emergencies`
  ...
  ADD CONSTRAINT `FK_ENREGION` FOREIGN KEY (`region_id`) REFERENCES `regions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
