...
INSERT INTO `emergencies` (`id`, `commune_id`, `admin_id`, `name`, `date`, `place`, `severity`, `description`, `status`) VALUES
(1, 1, 2, 'Inundacion en ñuble', '2016-12-25', 'nuble chico', 'G', 'SE INUNDO EL PUEBLO', 'En Progreso'),
(5, 3, 2, 'Incendio en casa', '2014-05-05', 'mi casa', 'G', 'mi casa se quema xDDDD.', 'Cancelada'),
(9, 3, 1, 'Vermillion Apocalypse', '2024-11-11', 'Zolezzi\'s Tower', 'G', 'OH GOD WHAT THE HELL IS GOING ON HERE?!?!?', 'En Progreso');
